var setJsonsHC = {
    ...
    StackedBar: function( jsonResponse ){
    ...
    DepartmentsStackedBar: function( jsonResponse ){
    ...
    FundingStackedBar: function( jsonResponse ){
    ...
    AdjudicationStackedBar: function( jsonResponse ){
    ...
    ProvidersStackedBar: function( jsonResponse ){
    ...
    ProvidersStackedBarByAmount: function( jsonResponse ){
